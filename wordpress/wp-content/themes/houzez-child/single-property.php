            ...
            <section class="content-wrap property-wrap property-detail-<?php echo esc_attr($top_area); ?> <?php echo esc_attr($layout_class); ?>">
                ...
                if( $loggedin_to_view == 1 && !is_user_logged_in()) {
                    ...
                    <div class="property-view full-width-property-view">
                        ...
                        <!-- Apply Button for v2 Layout -->
                        <a href="<?php echo esc_url(get_permalink(get_page_by_path('apply-for-rental'))); ?>?property_id=<?php the_ID(); ?>" class="btn btn-primary">Apply Now</a>
                    </div>
                    ...
                    <div class="row">
                        <div class="<?php echo esc_attr($content_classes); ?>">
                            ...
                            <div class="property-view">
                                ...
                                <!-- Apply Button for Other Layouts -->
                                <a href="<?php echo esc_url(get_permalink(get_page_by_path('apply-for-rental'))); ?>?property_id=<?php the_ID(); ?>" class="btn btn-secondary btn-sm-full-width">Apply Now</a>
